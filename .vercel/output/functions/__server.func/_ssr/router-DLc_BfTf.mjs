...
var styles_default = "/assets/styles-B_oj4kln.css";
var APP_NAME = "Clearance";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "BC.GAME session — live connection status and account balance."
			}
		],
		links: [
			{
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@500&family=Manrope:wght@400;500;600&family=Syne:wght@500;600;700&display=swap"
			}
		]
	}),
...
//#endregion
export { logoutFn as a, loginFn as i, Route as n, getSessionFn as r, router_exports as t };
